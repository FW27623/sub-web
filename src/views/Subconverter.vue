<template>
  <div>
      ...
      <el-col>
        <el-card>
          <div slot="header">
            ...
            <svg-icon icon-class="github" style="margin-left: 15px" @click="goToProject" />

            <div style="display: inline-block; position:absolute; right: 10px">{{ backendVersion }}</div>
          </div>
          <el-container>
    ...
    <el-footer style="text-align: center; padding: 10px 0">
      <span>© 2019-2023 <a href="https://www.fw1028.top" target="_blank">FangWei</a>. All rights reserved.</span>
    </el-footer>
  </div>
</template>
  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://sub.fw1028.top/sub?" }],
        remoteConfig: [
        {
          label: "ACL4SSR",
          options: [
      ...
      this.$axios
        ...
        .then(response => {
          ...
          if (response.data.success === "true") {
            this.curtomShortSubUrl = response.data.content.url;
            this.curtomShortSubUrl = this.curtomShortSubUrl.replace(/\\/g, "");
